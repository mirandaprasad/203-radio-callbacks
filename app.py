...
myheading1='Cats Are Cute'
tabtitle = 'xkcd'
list_of_options=['cat in a box!', 'cat in jeans!', 'git commit', 'scatterplot']
list_of_images=['boxcat.jpg', 'catjeans.jpg', 'gitcommit.jpg', 'scatterplot.png', 'good_code.png']
